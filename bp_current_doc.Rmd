...
```{r}
bp2 <- bp2 %>%
    mutate(grp=if_else(ts.use < '2018-03-15', "Pre admission",
               if_else(ts.use<='2018-04-06'&ts.use>='2018-03-15',"Post admission on 3.125",
               if_else(ts.use>'2018-04-06'&ts.use<='2018-04-25',"Off all carvedilol",
                if_else(ts.use>'2018-04-25'&ts.use<'2018-05-29',"Restart 3.125",
                       "Last 2 weeks (3.125mg)")))))
table(bp2$grp)
